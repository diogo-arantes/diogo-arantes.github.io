        ...
        if (currentBoss.name === "circular") {
            ...
            for (let i = 0; i < 5; i++) {
                ...
                if (
                    ...
                    updateManaBar();
                    playSound('scratching', playerLevel); // Add a sound effect for damage
                    return;
                }
            }
            ...
            if (
                ...
                updateManaBar();
                playSound('scratching', playerLevel);
            }
        }
    }
