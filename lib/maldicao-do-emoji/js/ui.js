...
function drawGroundAndCeiling() {
    ...
    const ceilingColor = lerpColor(prevLevelColor.ceiling, currentLevelColor.ceiling, t);
    const floorColor = lerpColor(prevLevelColor.floor, currentLevelColor.floor, t);
    ...
    groundGradient.addColorStop(0, floorColor);
